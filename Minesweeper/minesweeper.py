...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #creating new sentence object of new information contained in unknown
        self.knowledge.append(Sentence(unknown,count))

        #now after adding information in knowledge base
        ...
        for sentence in self.knowledge:
          ...
          # if they can be inferred from existing knowledge
          #from knowledge base check if any sentence is subset of another to deduce new information
        ...
        for i in range(len(self.knowledge)):
             for j in range(i+1,len(self.knowledge)):
                ...
                if sentence_1.cells.issubset(sentence_2.cells):
                    s = sentence_2.cells-sentence_1.cells
                    info = Sentence(s,sentence_2.count - sentence_1.count)
                    if info not in self.knowledge:
                        self.knowledge.append(info)
                elif sentence_2.cells.issubset(sentence_1.cells):
                     s = sentence_1.cells - sentence_2.cells
                     info = Sentence(s, sentence_1.count-sentence_2.count)
                     if info not in self.knowledge:
                         self.knowledge.append(info)
